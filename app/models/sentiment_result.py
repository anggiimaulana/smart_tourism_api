from sqlalchemy import Column, Integer, String, Text, Numeric, DateTime, Enum as PgEnum
...
class SentimentResult(Base):
    ...
    model_used      = Column(PgEnum("indobert","naive_bayes","svm","decision_tree",
                                   name="model_sentimen"), nullable=False)
